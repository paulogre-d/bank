...
<body>
  <div class="receipt-container">
    <div class="header">
      <div class="logo"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 10C0 4.47715 4.47715 0 10 0H30C35.5228 0 40 4.47715 40 10V30C40 35.5228 35.5228 40 30 40H10C4.47715 40 0 35.5228 0 30V10Z" fill="#155DFC"/><path d="M28 21C28 26 24.5 28.5 20.34 29.95C20.1222 30.0238 19.8855 30.0203 19.67 29.94C15.5 28.5 12 26 12 21V14C12 13.7348 12.1054 13.4804 12.2929 13.2929C12.4804 13.1054 12.7348 13 13 13C15 13 17.5 11.8 19.24 10.28C19.4519 10.099 19.7214 9.99955 20 9.99955C20.2786 9.99955 20.5481 10.099 20.76 10.28C22.51 11.81 25 13 27 13C27.2652 13 27.5196 13.1054 27.7071 13.2929C27.8946 13.4804 28 13.7348 28 14V21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 20L19 22L23 18" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
    ...
    <div class="footer">
      ...
      <p style="margin-top: 8px;">Vertex Premium Bank, N.A. Member FDIC. Equal Housing Lender.</p>
