...
export default function Sidebar({ onMenuClick, onLinkClick, sidebarOpen = false }: SidebarProps) {
  ...
  return (
    <aside className="flex h-full w-64 flex-col border-r border-[#E2E8F0] bg-white">
      {/* Logo + X close (mobile when open) / Hamburger (desktop) */}
      <div className="flex h-[88px] items-center gap-3 pl-4">
        <button
          ...
          aria-label={sidebarOpen ? "Close menu" : "Toggle sidebar"}
        >
          {sidebarOpen ? (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lg:hidden">
              <line x1="18" y1="6" x2="6" y2="18" />
              <line x1="6" y1="6" x2="18" y2="18" />
            </svg>
          ) : null}
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={sidebarOpen ? "hidden lg:block" : ""}>
